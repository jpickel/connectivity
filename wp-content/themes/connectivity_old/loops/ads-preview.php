        ...
        <?php if(get_row_layout() == "add_an_ad"): ?>
            ...
            <?php $post_object = get_sub_field('add_an_ad'); if( $post_object ): $post = $post_object; setup_postdata( $post ); ?>
                ...
                <div class="col-md-12">
                    ...
                    <?php if(get_field('primary_placement_collateral' )) { ?>
                    
                        <div class="col-md-12">
                            <img src="<?php the_field('primary_placement_collateral'); ?>">
                            <a href="<?php the_field('primary_placement_url'); ?>"><?php the_field('primary_placement_url'); ?></a>
                        </div>
